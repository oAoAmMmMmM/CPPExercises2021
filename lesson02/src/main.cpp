...
void task2() {
    ...
    std::cout << "current size array2d 1 is " << array2d.size() << std::endl;
    rassert(array2d.size() == 0, 123121);
    ...
    row0.push_back(8);
    row0.push_back(10);
    std::cout << "current size row0 1 is " << row0.size() << std::endl;
    rassert(row0.size() == 3, 123121);
    // TODO 22 добавьте rassert проверяющий размер этого вектора row0

    array2d.push_back(row0);
    std::cout << "current size array2d 2 is " << array2d.size() << std::endl;
    rassert(array2d.size() == 1, 123121);
    ...
    print2DArray(
            array2d); // TODO 24,25: откройте соседний файл - helper_function.cpp и реализуйте там эту функцию, можете туда быстро попасть через телепорт - держите нажатым CTRL->и кликните по этой функции
    ...
    std::cout << "current size row1 1 is " << row1.size() << std::endl;
    rassert(row1.size() == 3, "aboba");
    std::cout << "current size array2d 3 is " << array2d.size() << std::endl;
    rassert(array2d.size() == 2, "no good");
